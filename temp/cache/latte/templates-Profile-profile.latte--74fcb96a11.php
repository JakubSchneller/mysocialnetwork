<?php
// source: /Applications/MAMP/htdocs/mysocialnetwork/app/presenters/templates/Profile/profile.latte

use Latte\Runtime as LR;

class Template74fcb96a11 extends Latte\Runtime\Template
{
	public $blocks = [
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<div align="center">
										<a class="" href="#">
											<img class="media-object dp img-circle" src="../<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($users->image)) /* line 25 */ ?>" style="width: 180px;height:180px;">
										</a>
									</div>
								</div>
								<div class="col-md-12">
									<h2 align="center"><?php echo LR\Filters::escapeHtmlText($users->first_name) /* line 30 */ ?> <?php
		echo LR\Filters::escapeHtmlText($users->last_name) /* line 30 */ ?></h2>
